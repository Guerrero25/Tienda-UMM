 ...
 */
 class User_model extends ActiveRecord\Model
 {
   ...
   public function nuevoRegistro($nombre,$email,$username,$pass, $telefono)
   {
     $atributos = array('nombre' => $nombre, 'email' => $email, 'username' => $username, 'password' => $pass, 'telefono' => $telefono);
     return $this::create($atributos);
